...
export default function MuiButton() {
    ...
    const handleTextFormatChange = (event: MouseEvent<HTMLElement>, updatedFormats: string | null) => {
        setTextFormat(updatedFormats)
    }
    return (
        <Stack spacing={3} direction="row">
            <Button variant='contained' color='info'>Tap me hard</Button>
            <Button variant='outlined' size='small' >Tap me hard</Button>
            <ToggleButtonGroup
